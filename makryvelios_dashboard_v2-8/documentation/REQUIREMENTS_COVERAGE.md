# Requirements Coverage - Version 5.4.0
...
| Research commands | Questions, algorithms, equations, ordered steps, limitations and researcher notes |
| Evidence scoping | Exact XLSX/CSV variables, rows, filters and years; PDF documents, pages and keywords |
| Free natural language | Deterministic offline replies with optional local Ollama; no paid API key required |
| Paper support | Word/Markdown blueprint and ZIP containing scope, protocol, evidence and result tables |
